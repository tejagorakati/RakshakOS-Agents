...
export default function VolunteerCommunicationPage() {
  ...
  const getMessageModalData = (msg: MissionMessage): ModalContentData => ({
    ...
    badgeVariant: getMessageBadgeVariant(msg.senderType) as any,
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant={getMessageBadgeVariant(msg.senderType) as any} className="text-[10px] uppercase font-mono">
                      {msg.senderType}
                    </Badge>
                  </div>
